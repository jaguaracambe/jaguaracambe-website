...
import suport_pequi_background from '../../../public/suport/suport_pequi_background.jpg'
import suport_pequi_background_mobile from '../../../public/suport/suport_pequi_background_mobile.jpg'
    ...
    <main className={styles.homepage_container}>
      ...
      <section id="support" className={styles.supportContainer}>
        <Image
          src={
            windowWidth > 600
              ? suport_pequi_background
              : suport_pequi_background_mobile
          }
